...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $accnum = $userData['Acc_num'];

    // Insert into support table
    $sql = "INSERT INTO customer_service (Acc_name, Acc_num, Message) VALUES (?, ?, ?)";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssss", $loggedInUser,  $accnum, $message);
    $stmt->execute();
    $stmt->close();
...
<!--begin::Row-->
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0" style="font-weight: 990; color: #003366;">Developers</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="Dashboard.php">Developers</a></li>
...
<body>
  <div class="wrapper">
    <header>
      ...
      <div style="text-align:right;color:var(--muted);font-size:13px">Updated • Today</div>
    </header>

    <!-- Developer 1 -->
<article class="card" id="Earnest">
  <div class="avatar">
    <img src="../Profiles/Earnest_profile.jpg" alt="Profile photo of Earnest Reyes" />
  </div>
  <div class="meta">
    <div class="name-row">
      <div>
        <div class="name">Earnest Reyes</div>
        <div class="role">Backend Engineer</div>
      </div>
    </div>
    <p class="desc">
      Backend engineer and web developer with experience building secure login systems, 
      OTP authentication using Gmail, and database-driven applications. 
      Published websites using InfinityFree and developed Java GUI apps connected 
      to MySQL via XAMPP.
    </p>
    <div class="tags">
    ...
    <span class="tag">InfinityFree</span>
...
<article class="card">
  <div class="avatar">
    <img src="../Profiles/Carl's_profile.jpg" alt="Profile photo of Carl Joshua" />
  </div>
  <div class="meta">
    <div class="name-row">
      <div>
        <div class="name">Carl Joshua Coles</div>
        <div class="role">Java GUI Full Stack Developer</div>
      </div>
    </div>
    <p class="desc">
      Specializes in creating intuitive Java GUI applications with MySQL integration. 
      Skilled at designing user interfaces, handling database connectivity, and 
      building the core system logic for smooth workflows.
    </p>
    <div class="tags">
      <span class="tag">Java</span>
      <span class="tag">MySQL</span>
...
<article class="card">
  <div class="avatar">
    <img src="../Profiles/kclei_profile.jpg" alt="Profile photo of Kclei Umadhay" />
  </div>
  <div class="meta">
    <div class="name-row">
      <div>
        <div class="name">Kclei Umadhay</div>
        <div class="role">Frontend Engineer</div>
      </div>
    </div>
    <p class="desc">
      Creative UI/UX designer skilled in Canva and Figma, responsible for building 
      visually engaging designs and frontend layouts. Also contributed to system 
      logic development and user flow planning to ensure intuitive experiences.
    </p>
    <div class="tags">
      ...
      <span class="tag">Logic Planning</span>
    </div>
  </div>
</article>
...
<article class="card">
  <div class="avatar">
    <img src="../Profiles/Syd_profile.jpg" alt="Profile photo of Syd Villanueva" />
  </div>
  <div class="meta">
    <div class="name-row">
      <div>
        <div class="name">Syd Villanueva</div>
        <div class="role">UI/UX Designer / Analyst</div>
      </div>
    </div>
    <p class="desc">
      Supports the team by assisting with system logic, providing input on ideas, 
      and helping with the Java GUI design and functionality.
    </p>
    <div class="tags">
      <span class="tag">Java</span>
      <span class="tag">Logic Support</span>
      <span class="tag">UI/UX Assistance</span>
      <span class="tag">Team Support</span>
    </div>
  </div>
</article>
...
<article class="card">
  <div class="avatar">
    <img src="../Profiles/Hark_profile.jpg" alt="Profile photo of Hark foronda" />
  </div>
  <div class="meta">
    <div class="name-row">
      <div>
        <div class="name">Hark Foronda</div>
        <div class="role">Emotional Support</div>
      </div>
    </div>
    <p class="desc">
      Keeping the group members warm, provides financial support and helps manage the team’s budget.
    </p>
    <div class="tags">
  ...
  <footer class="app-footer">
    ...
    <script>
    const earnest = document.getElementById('Earnest');
    earnest.addEventListener('click', function(event) {
        window.location.href = "https://www.linkedin.com/in/earnest-rayleigh-reyes-2408a7388/?trk=opento_sprofile_goalscard";
    });
    </script>
