...
<!--begin::Row-->
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0" style="font-weight: 990; color: #003366;">Faqs</h3>
              </div>
              <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                  <li class="breadcrumb-item"><a href="Dashboard.php">Faqs</a></li>
  ...
  <section class="faq-section">
    <div class="card shadow-sm border-0">
      <div class="card-body p-4">
        <h2 class="mb-4 text-center fw-bold text-primary">Frequently Asked Questions</h2>
        <p class="text-center text-muted mb-5">Find answers to the most common questions about using our system.</p>
          ...
          <div class="accordion-item mb-3 border-0 shadow-sm rounded">
            <h2 class="accordion-header" id="headingOne">
              <button class="accordion-button fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne">
                <i class="bi bi-person-plus-fill me-2 text-primary"></i> How do I create an account?
              </button>
            </h2>
            <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-muted">
                Click on the <strong>Register</strong> link in the navigation and fill out the required information. Once submitted, you’ll receive a confirmation email to activate your account.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-3 border-0 shadow-sm rounded">
            <h2 class="accordion-header" id="headingTwo">
              <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo">
                <i class="bi bi-shield-lock-fill me-2 text-success"></i> Can I reset my password?
              </button>
            </h2>
            <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-muted">
                Yes! Use the <strong>Forgot Password</strong> link on the login page, or go to <strong>Security</strong> in the sidebar. Follow the steps to reset your password securely.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-3 border-0 shadow-sm rounded">
            <h2 class="accordion-header" id="headingThree">
              <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree">
                <i class="bi bi-headset me-2 text-danger"></i> How do I contact support?
              </button>
            </h2>
            <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-muted">
                Navigate to the <strong>Help</strong> page or <strong>Customer Support</strong> and fill out the contact form. Our support team will respond within 24–48 hours.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-3 border-0 shadow-sm rounded">
            <h2 class="accordion-header" id="headingFour">
              <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour">
                <i class="bi bi-credit-card-fill me-2 text-warning"></i> Are there any fees for using the system?
              </button>
            </h2>
            <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-muted">
                No, our system is free to use. However, certain premium features may be available in the future with minimal fees.
              </div>
            </div>
          </div>
          ...
          <div class="accordion-item mb-3 border-0 shadow-sm rounded">
            <h2 class="accordion-header" id="headingFive">
              <button class="accordion-button collapsed fw-bold" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFive">
                <i class="bi bi-phone-fill me-2 text-info"></i> Can I access the system on mobile?
              </button>
            </h2>
            <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
              <div class="accordion-body text-muted">
                Yes, our platform is fully responsive and works on desktops, tablets, and mobile devices for your convenience.
              </div>
            </div>
          </div>
