...
$stmt->execute();
$stmt->bind_result($age, $birthday, $mobile, $status, $accnum);
$stmt->fetch();
$stmt->close();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: About.php"); // redirect back to profile
    exit;
}
...
<!--begin::Row-->
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0" style="font-weight: 990; color: #003366;">About</h3>
              </div>
              <div class="col-sm-6">
  ...
  <section class="about-section">
    <div class="card shadow-sm border-0">
      <div class="card-body p-5 text-center">
        ...
        <!-- Logo -->
        <div class="mb-4">
          <img src="ui/tbalogo.png" alt="TBA Bank Logo" class="img-fluid" style="max-height: 100px;">
        </div>

        <!-- Title -->
        <h2 class="fw-bold mb-4 text-primary">About TBA Bank Queueing System (TBAQS)</h2>
        <p class="lead text-muted mb-5">
          TBA Bank has been committed to serving communities with excellence, trust, and innovation. 
          To enhance customer service, we developed the <strong>TBA Queueing System (TBAQS)</strong> — 
          a modern solution that ensures efficient and organized service for every client who walks into our branches.
        </p>
        ...
        <div class="mb-5">
          ...
          <p class="text-muted">
            Our mission at TBA Bank is to provide accessible, secure, and reliable financial services. 
            With TBAQS, we aim to reduce waiting times, simplify customer interactions, and ensure a smooth banking experience 
            while maintaining the trust and reliability we are known for.
          </p>
        </div>

        <!-- Vision -->
        <div class="mb-5">
          <h4><i class="bi bi-eye-fill text-success me-2"></i> Our Vision</h4>
          <p class="text-muted">
            We envision a banking environment where customers spend less time waiting and more time achieving their financial goals. 
            By embracing digital innovation and customer-first design, TBA Bank seeks to set the standard in efficient banking operations.
          </p>
        </div>

       <!-- Core Values -->
<div class="mb-5">
  <h4><i class="bi bi-heart-fill text-danger me-2"></i> Our Core Values</h4>
  <p class="text-muted mb-4">
    At TBA Bank, we are guided by five core values that shape everything we do:
  </p>

  <div class="row g-4">
    <!-- Integrity -->
    <div class="col-12 col-md-6 col-lg-4">
      <div class="p-3 h-100 shadow-sm rounded bg-light text-center">
        <i class="bi bi-shield-lock text-primary fs-2 mb-2"></i>
        <h6 class="fw-bold">Integrity</h6>
        <p class="text-muted small">We conduct business with honesty, transparency, and accountability.</p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="p-3 h-100 shadow-sm rounded bg-light text-center">
        ...
        <h6 class="fw-bold">Reliability</h6>
        <p class="text-muted small">Our services and systems are dependable and secure.</p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="p-3 h-100 shadow-sm rounded bg-light text-center">
        ...
        <h6 class="fw-bold">Customer-Centered</h6>
        <p class="text-muted small">We prioritize client needs and convenience above all else.</p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-6">
      <div class="p-3 h-100 shadow-sm rounded bg-light text-center">
        <i class="bi bi-lightbulb-fill text-info fs-2 mb-2"></i>
        <h6 class="fw-bold">Innovation</h6>
        <p class="text-muted small">We adapt modern technology to enhance customer service and banking efficiency.</p>
      </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-6">
      <div class="p-3 h-100 shadow-sm rounded bg-light text-center">
        <i class="bi bi-star-fill text-danger fs-2 mb-2"></i>
        <h6 class="fw-bold">Excellence</h6>
        <p class="text-muted small">We deliver high-quality financial solutions and customer care.</p>
      </div>
    </div>
  </div>
</div>
        ...
        <!-- Why Choose Us -->
        <div class="mb-5">
          <h4><i class="bi bi-check-circle-fill text-warning me-2"></i> Why Choose TBA Bank?</h4>
          <p class="text-muted">
            As a trusted financial institution, TBA Bank goes beyond traditional banking by investing in solutions like TBAQS 
            to ensure smooth and reliable services. With our modern queueing system, clients can enjoy organized transactions, 
            reduced waiting times, and personalized banking assistance tailored to their needs.
          </p>
        </div>
        ...
        <div>
          <p class="fw-semibold text-muted">
            At <strong>TBA Bank</strong>, your time and trust are our priorities. 
            With TBAQS, we continue our promise of delivering financial services that are fast, secure, and customer-focused.
          </p>
        </div>
      </div>
    </div>
