...
$stmt->execute();
$stmt->bind_result($age, $birthday, $mobile, $status, $accnum, $email);
$stmt->fetch();
$stmt->close();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $accnum = $userData['Acc_number'];

    // Insert into support table
    $sql = "INSERT INTO customer_service (Gmail, feedbacks) VALUES (?, ?)";
    $stmt = $conn->prepare($sql);
...
<html lang="en">
  ...
  <head>
    ...
    <title>TBAQS | Customer Support</title>
...
<!--begin::Row-->
            <div class="row">
              <div class="col-sm-6">
                <h3 class="mb-0" style="font-weight: 990; color: #003366;">Customer Support</h3>
              </div>
              <div class="col-sm-6">
...
<div class="card card-primary card-outline direct-chat direct-chat-primary">
  <div class="card-header">
    <h3 class="card-title" style="font-family: 'Montserrat', sans-serif; font-weight: 700;">Contact Us!</h3>
  ...
  <div class="card-body">
    <div class="contact-form-container p-3">
      <div class="header mb-4">
        <p class="text-secondary">Need help? Our support team is here for you.</p>
      </div>
        ...
        <div class="row">
          <div class="col-md-6 mb-3">
            <div class="form-group">
              ...
              <input type="text" id="name" name="name" value="<?php echo $loggedInUser; ?>" class="form-control" />
            </div>
          </div>
          <div class="col-md-6 mb-3">
            <div class="form-group">
